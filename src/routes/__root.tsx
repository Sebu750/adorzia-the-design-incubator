...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "fashion incubator, emerging designers, fashion marketplace, coworking studio, fashion spotlight, designer incubation, creative entrepreneurship" },
